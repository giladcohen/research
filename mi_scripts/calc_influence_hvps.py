...
parser.add_argument('--grad_z_set', default='member_train_set', type=str, help='train set to calculate single influences: member_train_set/non_member_train_set')
parser.add_argument('--s_test_set', default='member_train_set', type=str, help='set to calculate s_test for: member_train_set/non_member_train_set/member_test_set/non_member_test_set')
