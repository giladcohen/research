...
if args.fast:
    ...
    if not os.path.exists(os.path.join(OUTPUT_DIR, 'X_member_train_fast.npy')):
        X_member_train, y_member_train = randomize_max_p_points(X_member_train, y_member_train, 250)  # reduced to 50 to save time
        X_non_member_train, y_non_member_train = randomize_max_p_points(X_non_member_train, y_non_member_train, 250)
        X_member_test, y_member_test = randomize_max_p_points(X_member_test, y_member_test, 1250)
        X_non_member_test, y_non_member_test = randomize_max_p_points(X_non_member_test, y_non_member_test, 1250)
