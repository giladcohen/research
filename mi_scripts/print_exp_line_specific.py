...
parser.add_argument('--attack_dir', default='/data/gilad/logs/mi/tiny_imagenet/alexnet/relu/s_25k_w_aug/adaptive/self_influence_average', type=str, help='checkpoint dir')
# parser.add_argument('--attack_dir', default='/data/gilad/logs/mi/cifar100/densenet/relu/s_50k_w_aug/adaptive/self_influence_v3', type=str, help='checkpoint dir')
